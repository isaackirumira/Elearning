                            ...
                            <div class="block-content collapse in">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
                                         ...
                                         <?php
                                    $query = mysql_query("select * from student_elearning LEFT JOIN class ON class.class_id = student_elearning.class_id ORDER BY student_elearning.student_id DESC") or die(mysql_error());
