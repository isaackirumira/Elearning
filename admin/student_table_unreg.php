	...
	<?php include('modal_delete.php'); ?>
		...
		<?php
	$query = mysql_query("select * from student_elearning LEFT JOIN class ON student_elearning.class_id = class.class_id where status = 'Unregistered' ORDER BY student_elearning.student_id DESC") or die(mysql_error());
