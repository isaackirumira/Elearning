                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php 
								$query_student = mysql_query("select * from student_elearning where status='Registered'")or die(mysql_error());
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Registered Students</strong>
										...
										<?php 
								$query_student = mysql_query("select * from student_elearning")or die(mysql_error());
								$count_student = mysql_num_rows($query_student);
								?>
