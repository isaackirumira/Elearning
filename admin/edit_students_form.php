   <div class="row-fluid">
       <a href="students.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Student</a>
                        ...
                        <div class="block">
							...
							<?php
							$query = mysql_query("select * from student_elearning LEFT JOIN class ON class.class_id = student_elearning.class_id where student_id = '$get_id'")or die(mysql_error());
	      ...
	      <?php
                            if (isset($_POST['update'])) {
								...
								mysql_query("update student_elearning set username = '$un' , firstname ='$fn' , lastname = '$ln' , class_id = '$cys' where student_id = '$get_id' ")or die(mysql_error());
