									...
									<div class="control-group">
                                          ...
                                          <div class="controls">
											...
											$query = mysql_query("select * from teacher_class_student
																  LEFT JOIN student ON student_elearning.student_id = teacher_class_student_elearning.student_id
											 group by teacher_class_student_elearning.student_id order by firstname ASC");
