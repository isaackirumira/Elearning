                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								$my_student = mysql_query("SELECT * FROM teacher_class_student
														LEFT JOIN student_elearning ON student_elearning.student_id = teacher_class_student.student_id 
														INNER JOIN class ON class.class_id = student_elearning.class_id where teacher_class_id = '$get_id' order by lastname ")or die(mysql_error());
